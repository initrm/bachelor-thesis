...
Sia $A = (Q, \Sigma, \delta, q_I, F)$ un automa a stati finiti deterministico e $q_A, q_B \in Q$ due stati,
...
attraverso una versione semplificata dell'algoritmo di Tarjan \cite{DFI08}, in quanto essendo $A'$ minimo 
tutti gli stati in $Q'$ sono raggiungibili da $q_I'$, per l'identificazione delle componenti fortemente
connesse. Questo avviene semplicemente in quanto, per definizione, gli stati centrali sono parte di una
...
in Tabella \ref{tab:hm-hash-table}, risulta correttamente essere $\partitioned{Q}{\sim}$.
