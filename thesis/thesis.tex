...
Questo significa che, a meno di isomorfismi, non esiste un automa differente con lo stesso numero di stati che 
...
in ingresso $A$ ottenendo l'automa minimo $A' = (Q', \Sigma, \delta', \allowbreak q_I', F')$.
