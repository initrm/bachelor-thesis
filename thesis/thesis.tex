...
\begin{corollary}\label{cor:cross-prod-state-aeq-states}
  Il linguaggio indotto da uno stato $(q, r) \in Q^\otimes$ è finito se e solo se $q \sim r$, pertanto, 
...
\begin{figure}
  \centering
  \includegraphics[width=0.9\linewidth]{images/xcp_end.png}
